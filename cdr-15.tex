...
\label{sec:org4311a30}
\subsection{Description}
\label{sec:orgabf7b90}
\subsubsection{Concept}
\label{sec:orgeeb1952}
...
\subsubsection{API}
\label{sec:orge80f942}
\noindent\rule{\textwidth}{0.5pt}
\begin{enumerate}
\item defpackage
\label{sec:org5ff5bdb}
...
See \hyperref[sec:org5dc5d2d]{add-package-local-nickname: exceptional situations}.
\item Implementation dependent
\label{sec:orgeeb9a98}
...
\end{enumerate}
\item make-package
\label{sec:orgce30ef8}
\hyperref[sec:org12812f0]{Proposal\#6}
...
\item Implementation dependent
\label{sec:orgdc9b30a}
\textbf{PROPOSAL} (See \hyperref[sec:orgd3bca0d]{issues\#4}.)
...
\label{sec:org77bbc74}
\noindent\rule{\textwidth}{0.5pt}
\begin{enumerate}
\item defpackage
\label{sec:orge9dce56}
See \hyperref[sec:org5ff5bdb]{defpackage}.

\noindent\rule{\textwidth}{0.5pt}
\item make-package
\label{sec:orgc3f5fbf}
See \hyperref[sec:orgce30ef8]{make-package}.

\noindent\rule{\textwidth}{0.5pt}
\item find-package
\label{sec:org24ccf35}

...
\label{sec:orgfafe861}
\subsection{Description}
\label{sec:org0dfbb29}
\subsubsection{Concept}
\label{sec:org63b446f}
...
see \hyperref[sec:orgfad362d]{PRINT-READ consistency}.
...
\subsubsection{API}
\label{sec:orgbdfc4fe}
\noindent\rule{\textwidth}{0.5pt}
\begin{enumerate}
\item defpackage
\label{sec:org220d605}
...
See \hyperref[sec:orgd658e00]{add-package-local-nickname: exceptional situations}.
\item Implementation dependent
\label{sec:org6fc660e}
...
\label{sec:org1c2e5e1}
\noindent\rule{\textwidth}{0.5pt}
\begin{enumerate}
\item defpackage
\label{sec:org160dcb2}
See \hyperref[sec:org220d605]{defpackage}.

\noindent\rule{\textwidth}{0.5pt}
\item make-package
\label{sec:org6b37cba}
See \hyperref[sec:org8c9cb8f]{make-package}.

\noindent\rule{\textwidth}{0.5pt}
\item find-package
\label{sec:orgbba0132}
...
\label{sec:orgf7c9ded}
\begin{enumerate}
\item PRINT-READ consistency
\label{sec:orgfad362d}

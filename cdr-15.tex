...
\label{sec:org6e6f1b2}
\subsection{Description}
\label{sec:orgd7a2680}
\subsubsection{Concept}
\label{sec:org51eb7d3}
...
see \hyperref[sec:org7b3a02a]{PRINT-READ consistency}.
...
\subsubsection{API}
\label{sec:orgedac734}
\noindent\rule{\textwidth}{0.5pt}
\begin{enumerate}
\item defpackage
\label{sec:org3f53b78}
...
See \hyperref[sec:org4745e84]{add-package-local-nickname: exceptional situations}.
\item Implementation dependent
\label{sec:org4858a26}
...
\end{enumerate}
\item make-package
\label{sec:org916fe2c}
\hyperref[sec:orgc22c0d7]{Proposal\#6}
...
\item Implementation dependent
\label{sec:org4bb6bef}
\textbf{PROPOSAL} (See \hyperref[sec:org9520579]{issues\#4}.)
...
\label{sec:orgae6fec4}
\noindent\rule{\textwidth}{0.5pt}
\begin{enumerate}
\item defpackage
\label{sec:org674c0dd}
See \hyperref[sec:org3f53b78]{defpackage}.

\noindent\rule{\textwidth}{0.5pt}
\item make-package
\label{sec:org78d39dd}
See \hyperref[sec:org916fe2c]{make-package}.

\noindent\rule{\textwidth}{0.5pt}
\item find-package
\label{sec:org5acc822}
...
\subsection{Examples}
\label{sec:org6d8130b}
[TODO]
\section{Links}
\label{sec:org2aa0a3f}

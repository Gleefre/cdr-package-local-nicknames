...
For details see \hyperref[sec:orgf761a29]{Issue 2}.
...
\subsection{API}
\label{sec:orga179bb3}
\subsubsection{defpackage}
\label{sec:org5a7a00d}
...
See \hyperref[sec:orgce137a0]{add-package-local-nickname: exceptional situations}.
\item Implementation dependent
\label{sec:org1cc1c19}
The behaviour is unspecified when a \emph{local nickname} is specified for the package
that is being defined. (See \hyperref[sec:org588dc3a]{Issue 4}.)
...
\label{sec:org337996c}
(\textbf{PROPOSAL}: see \hyperref[sec:org4097cbd]{Issue 6}.)
...
See \hyperref[sec:orgce137a0]{add-package-local-nickname: exceptional situations}.
\item Implementation dependent
\label{sec:orgc085449}
The behaviour is unspecified when a \emph{local nickname} is specified for the package
that is being defined. (See \hyperref[sec:org588dc3a]{Issue 4}.)
\end{enumerate}
\subsubsection{add-package-local-nickname}
\label{sec:org47a2086}
\begin{verbatim}
...
Returns the package designated by \texttt{designated-package}. (But also see \hyperref[sec:org735a07e]{Issue 1}.)

If a \emph{nickname} is already defined, checks that it is defined for the package
designated by \texttt{actual-package}.
\begin{enumerate}
\item Arguments and Values
\label{sec:org7af9bf9}
\texttt{nickname} must be a \emph{string designator}.
...
(\textbf{PROPOSAL}: see \hyperref[sec:orga6a8c7a]{Issue 5}.)
...
otherwise. (But also see \hyperref[sec:org735a07e]{Issue 1}.)
\begin{enumerate}
\item Arguments and Values
\label{sec:orga486251}
...
\begin{enumerate}
\item Arguments and Values
\label{sec:orgc454a03}
\texttt{package} must be a \emph{package designator}.

\texttt{packages-list} is a \emph{list} with elements of type \emph{package}.
\item Exceptional situations
\label{sec:org558c773}
An error of type \texttt{package-error} is signaled when a package designated by
\texttt{package} does not exists.
\item Notes
\label{sec:org9c5ad82}
The returned \emph{list} must be safe to be modified by the user.
\end{enumerate}
\subsection{Affected symbols}
\label{sec:org6a250c6}
\subsubsection{defpackage}
\label{sec:org310a6ad}
See \hyperref[sec:org5a7a00d]{defpackage}.
\subsubsection{make-package}
\label{sec:org03661c2}
See \hyperref[sec:org337996c]{make-package}.
\subsubsection{find-package}
\label{sec:org2a9a5bc}
...
(\textbf{PROPOSAL}: see \hyperref[sec:org17e23f2]{Issue 8}.)
...
\label{sec:org21c6493}
See \hyperref[sec:org17e23f2]{Issue 8}.
\subsubsection{$\backslash$*features$\backslash$*}
\label{sec:org460cf0d}
...
\subsection{Examples}
\label{sec:orge2be266}
[TODO]
\section{ISSUES}
\label{sec:orgeb2a0a8}

\subsection{Issue 1 ([ADD-/REMOVE-]PACKAGE-LOCAL-NICKNAME return values)}
\label{sec:org735a07e}
\subsubsection{Description}
\label{sec:orge215882}
...
\label{sec:orgf761a29}
\subsubsection{Description}
\label{sec:orge652c38}
...
\label{sec:org0669450}
\subsubsection{Description}
\label{sec:org090cc4d}
...
\label{sec:org588dc3a}
\subsubsection{Description}
\label{sec:orgcc0210f}
...
\label{sec:org4097cbd}
\subsubsection{Current behavior}
\label{sec:orgd56afe0}
...
\label{sec:org001ceef}
\subsubsection{Description}
\label{sec:orgc5155a0}
...
\label{sec:org17e23f2}
\emph{by |3b|}
\subsubsection{Description}
\label{sec:org7bf2e8a}
...
\label{sec:orgd1fce73}
\subsubsection{Description}
\label{sec:org5eef079}
